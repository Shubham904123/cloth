            ...
            <div className="col-md-10 bg4">
                ...
                {data.map((v) => (
                    <div className='col-lg-3 col-md-4 col-sm-4 col-xs-6 f-fmly' style={{ marginBottom: 30, cursor: 'pointer' }}>
                        <div className='scroll-bar1' style={{ boxShadow: '0 0 3px rgba(0,0,0,.5', borderRadius: '5px', height: 250, overflowX: 'scroll', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 30 }}>
                        ...
                        <div class="modal-body">
                            <form encType='multipart/form-data' onSubmit={editf}>
                                <div className="form-group">
                                    <input type="text" className="form-control" value={nm} onChange={(e) => setnm(e.target.value)} name="fname" placeholder="Enter Cloth Name" />
                                </div>
                                <div className="form-group">
                                    <input type="text" className="form-control" value={pr} onChange={(e) => setpr(e.target.value)} name="fprc" placeholder="Enter Cloth Price" />
                                </div>
                                <div className='form-group'>
                                ...
                                <div className='form-group'>
                                    <select className='form-control' value={mn} onChange={(e) => setnm(e.target.value)} name='men'>
