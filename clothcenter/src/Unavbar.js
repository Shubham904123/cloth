                                ...
                                <>
                                    <li onClick={getcart}>
                                        <a href="" data-target="#myModal2" data-toggle="modal">
                                            ...
                                            <span class="badge">{product?.productDetail?.length}</span>
                                        </a>
                                    </li>
                                    <li>
                                        ...
                                        <tbody>
                                            {product.productDetail.map((v) => (
                                                <tr>
                                                    ...
                                                    <td className="td1">{v.fprc}</td>
                                                    <td className=" td1">
                                                        <div className="btn-group">
                                                            {v.fqty <= 1 ? (
                                                                <button
                                                                    // onClick={() => del(v._id)}
                                                                    className="btn1 btn btn-default"
                                                                >
                                                            ...
                                                            <button className="btn1 btn btn-default" disabled>
                                                                {v.fqty}
                                                            </button>
                                                            <button
                                                                // onClick={() => incre(v)}
