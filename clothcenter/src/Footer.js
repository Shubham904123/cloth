...
export default function Footer() {
    ...
    return (
        <>
            <footer>
                <div className="">
                    <div className="col-xs-12 bg7" style={{ paddingBottom: 20 }}>
                        <div className="col-md-4 col-sm-6 col-xs-12">
                            <h3 className="f-fmly" style={{ margin: '40px 0' }}>About Us</h3>
                            <div className="f-fmly">
                                <p>We are the country’s number 1 destination for beautiful clothes. Surf through 6000+ clothes from top our designers and learn about latest news from the world of fashion.
                                    <br /><br />
                                    We are known for its high-end quality and stylish design.Our clothing store is a trusted Indian shop with a particular customer base
                                </p>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-12">
                            ...
                            <h5 className="f-fmly">Phone No:9854851254</h5>
